<?php
class Card_want_model extends CI_Model {
	...
	*/
	...
	{
		$this->db->insert('card_want', array('card_id'=>$card_id,'user_id'=>$user_id));
	}
	...
	*/
	...
	{
		$query=$this->db->get_where('card_want',array('id'=>$id));
		$result=$query->row_array();
		$this->db->insert('card_want_deleted',$result);
		$this->db->delete('card_want',$result);
	}
	...
	*/
	...
	{
		$query=$this->db->get_where('card_want',array('card_id'=>$card_id,'user_id'=>$user_id));
		$result=$query->row_array();
		$this->db->insert('card_want_deleted',$result);
		$this->db->delete('card_want',$result);
	}
